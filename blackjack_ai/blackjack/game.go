...
var (
	errBust = errors.New("hand score eceeded 21")
)
...
func MoveDouble(g *Game) error {
	if len(*g.currentHand()) != 2 {
		return errors.New("Can only dobe on an hand with two cards")
	}
	g.playerBet *= 2
	MoveHit(g)
	return MoveStand(g)
...
// Soft returns true if the score of a hand is a soft score - that is
...
// func Shuffle(gs Game) Game {
// 	ret := clone(gs)
// 	ret.Deck = deck.New(dec.Deck(3), deck.Shuffle)
// 	return ret
// }
