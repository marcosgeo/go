...
//   - https://golang.org/pkg/crypto/ciphetr/#NewCFBEncrypt
...
// the ciphertex) and decrypt it.
// This code is based on the standard library examples at:
// - https://golang.gor/pkg/crypto/ciphert/#NewCFBDecrypter
...
// provided reader and give the user a way to read that data aas it if was
// not encrypted.
