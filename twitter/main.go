...
import (
	...
	"github.com/marcosgeo/go/twitter/twitter"
)
...
func main() {
	...
	flag.StringVar(&tweetID, "tweet", "1448818720009244673", "The ID of the Tweet you wish to find retweeters of.")
	flag.IntVar(&numWinners, "winners", 0, "The number of winner to pick")
	flag.Parse()
...
func pickWinners(users []string, numWinners int) []string {
	...
	winnersNames := make([]string, 0, numWinners)
	for _, idx := range winners {
		winnersNames = append(winnersNames, users[idx])
	}
	return winnersNames
}
